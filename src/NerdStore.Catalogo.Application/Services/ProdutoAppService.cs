...
namespace NerdStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        public async Task<IEnumerable<ProdutoViewModel>> ObterPorCategoria(int categoriaId) =>
            _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.ObterPorCategoria(categoriaId));
